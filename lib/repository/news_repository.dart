...
class NewsRepository {
  Future<List<NewsModel>> fetchNews() async {
    ...
    // List untuk menyimpan data dari Json
    ...
    if (response.statusCode == 200) {
      for (var data in jsonData[NewsApiConstants.articles]) {
        if (data[NewsApiConstants.urlToImage] != null) {
          // Menyimpan data yang diambil dari Json dalam bentuk data ke dalam articleModel
  ...
  Future<List<NewsModel>> fetchBreakingNews() async {
    ...
    if (response.statusCode == 200) {
      ...
      // Mengembalikan list kosong inisialisasi awal
      return articleModelList;
    }
  }
